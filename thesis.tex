...
Computing the most likely sequence of hidden states naïvely is computationally expensive. But using the Viterbi algorithm makes the computation much more efficient. This algorithm may be divided into three phases: \begin{enumerate*}
	\item initialisation \item forward computation, and \item backward computation (retracing).
\end{enumerate*}
