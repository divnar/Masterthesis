...
\begin{spacing}{1.1}
  \begin{algorithm}[H]
	...
	\label{alg:viterbi}
	\KwIn{\\$Y$: observations,\\ logP: priors\\ logA: transition matrix\\ logB: emission matrix \vspace{1em}}
...
%	s_{10} & s_{11} & \cdots & s_{1} \\
%	\vdots & \vdots & \ddots & \vdots \\
%	s_{n0} & s_{n1} & \cdots & s_{nm}
%\end{bmatrix}
%\]
